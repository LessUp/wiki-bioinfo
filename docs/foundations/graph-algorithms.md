...
<DefinitionList
  items={[
    {
      term: '与 Eulerian Cycle 的区别',
      definition: 'Eulerian Cycle 访问每条边恰好一次，Hamiltonian Cycle 访问每个顶点恰好一次。',
    },
    {
      term: '计算复杂性',
      definition: '判定图是否有 Hamiltonian Cycle 是 NP-complete 的。',
    },
    {
      term: '与旅行商问题（TSP）的关系',
      definition: 'TSP 是带权图上的 Hamiltonian Cycle，寻找总权重最小的回路。',
    },
  ]}
/>
