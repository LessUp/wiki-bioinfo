...
相似性网络融合（Similarity Network Fusion, SNF）是一种基于网络的多组学整合方法。
...
与传统方法（如 NMF、CCA）不同，SNF 不对数据分布做假设，而是将数据转化为图表示。
...
- [MOFA+](./mofa-plus.md)
- [图算法基础](../applications/graph-algorithms.md)
