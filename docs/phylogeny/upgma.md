---
sidebar_position: 7
description: UPGMA算法详解：层次聚类构建系统发育树，理解分子钟假设和平均距离聚合策略。
pagination_label: UPGMA算法
---
...
UPGMA（Unweighted Pair Group Method with Arithmetic Mean）是一种自底向上的层次聚类算法，用于从距离矩阵构建系统发育树。

它的核心特点是：
- 每次迭代选择距离最近的两个类群进行合并
- 合并后的新类群与其他类群的距离使用算术平均值计算
- 最终得到一棵有根树，所有叶子到根的距离相等（满足分子钟假设）
