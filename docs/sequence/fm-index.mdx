---
sidebar_position: 4
description: FM-index 概览，解释 BWT 之上的压缩全文索引如何支持高效 exact matching。
pagination_label: FM-index
---
...
<SummaryBox
  summary="FM-index 是理解‘为什么 read mapper 能在巨大参考基因组上快速查找’的关键一页：它把 BWT 的可压缩性和 backward search 的区间更新结合起来。"
  bullets={[
    '先理解 suffix array 和 BWT，再看 FM-index 会更自然。',
    '这页的重点是索引骨架和搜索思路，不是完整比对算法。',
  ]}
/>
