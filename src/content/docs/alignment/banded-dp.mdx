...
<PrerequisitesBox
  links={[
    { title: 'Needleman-Wunsch 算法', href: '/wiki-bioinfo/alignment/needleman-wunsch', description: '带状 DP 所基于的标准全局比对算法' },
    { title: 'Smith-Waterman 算法', href: '/wiki-bioinfo/alignment/smith-waterman', description: '带状 DP 同样适用于局部比对' },
    { title: '编辑距离', href: '/wiki-bioinfo/alignment/edit-distance', description: '理解 DP 递推关系的基础' },
  ]}
/>
...
<ComparisonTable
  ...
  rightTitle="带状 DP"
  rows={[
    { aspect: '时间复杂度', left: 'O(mn)', right: 'O(b·min(m,n))' },
    { aspect: '空间复杂度', left: 'O(mn)', right: 'O(b·min(m,n))' },
    { aspect: '最优性保证', left: '总是最优', right: '只有在带宽足够时才最优' },
    { aspect: '适用场景', left: '通用', right: '高相似度序列' }
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'Needleman-Wunsch 算法', to: '/wiki-bioinfo/alignment/needleman-wunsch', description: '带状 DP 所基于的标准全局比对动态规划算法' },
    { title: 'Smith-Waterman 算法', to: '/wiki-bioinfo/alignment/smith-waterman', description: '局部比对的标准动态规划算法，同样可以使用带状优化' },
    { title: 'Hirschberg 算法', to: '/wiki-bioinfo/alignment/hirschberg', description: '将全局比对空间复杂度优化到线性，与带状 DP 互补' },
    { title: '编辑距离', to: '/wiki-bioinfo/alignment/edit-distance', description: '序列比对的最简形式，理解 DP 递推关系的起点' },
    { title: 'BLAST', to: '/wiki-bioinfo/alignment/blast', description: '基于 seed-and-extend 的实际工具，扩展阶段常用带状 DP' },
  ]}
/>
