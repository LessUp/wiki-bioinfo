...
<figure>
  ...
  <figcaption>构造一个包含空串行列的动态规划矩阵，蓝色高亮为匹配（代价 0），黄色高亮为替换（代价 1），箭头标出一条最优路径。最终 dp[4][4] = 2，表示最小编辑距离为 2。</figcaption>
</figure>
...
- [索引结构概览](../sequence/indexing/)
- [RNA-seq 工作流概览](../workflows/rna-seq/)
