...
<PrerequisitesBox
  items={[
    ...
    { name: '分治算法', href: '/wiki-bioinfo/foundations/divide-and-conquer' },
...
<RelatedLinks
  links={[
    { title: '分治算法', to: '/wiki-bioinfo/foundations/divide-and-conquer', description: '算法基础' },
    { title: 'Needleman-Wunsch', to: '/wiki-bioinfo/alignment/needleman-wunsch', description: '全局比对基础' },
    { title: '最长公共子序列', to: '/wiki-bioinfo/alignment/longest-common-subsequence', description: 'LCS 问题' }
  ]}
/>
