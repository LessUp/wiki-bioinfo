...
2. [全局比对与局部比对](./global-local/)
3. [打分矩阵与 gap 罚分](./scoring-matrices/)
4. [半全局比对](./semi-global-alignment/)
5. [Affine gap penalty](./affine-gap-penalty/)
6. [Needleman-Wunsch 算法](./needleman-wunsch/)
7. [Smith-Waterman 算法](./smith-waterman/)
8. [Gotoh 算法](./gotoh/)
9. [Hirschberg 算法](./hirschberg/)
10. [带状动态规划](./banded-dp/)
11. [BLAST：基于 seed-and-extend 的局部搜索](./blast/)
12. [Minimap2 比对算法](../long-read/minimap2-alignment/)
13. [多序列比对（MSA）](./multiple-sequence-alignment/)
