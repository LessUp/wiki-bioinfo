...
- [编辑距离](./edit-distance/) - 允许替换操作的扩展
- [全局比对与 Needleman-Wunsch](./needleman-wunsch/) - 引入打分矩阵的全局比对
- [局部比对与 Smith-Waterman](./smith-waterman/) - 寻找最佳局部相似性
- [曼哈顿游客问题](../foundations/manhattan-tourist/) - 理解 DP 的几何直观
- [动态规划基础](../foundations/dynamic-programming-basics/) - DP 的核心思想
