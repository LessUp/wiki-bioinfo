...
<PrerequisitesBox
  links={[
    { title: 'Needleman-Wunsch 算法', href: '/wiki-bioinfo/alignment/needleman-wunsch', description: '全局比对基础，理解 SW 递推公式的前提' },
    { title: '编辑距离', href: '/wiki-bioinfo/alignment/edit-distance', description: '理解 DP 递推关系的最简起点' },
    { title: '打分矩阵与 gap 罚分', href: '/wiki-bioinfo/alignment/scoring-matrices', description: '影响局部比对结果的打分体系' },
  ]}
/>
...
<ComparisonTable
  ...
  rightTitle="Smith-Waterman"
  rows={[
    { aspect: '比对类型', left: '全局比对', right: '局部比对' },
    { aspect: '边界条件', left: '`F[i][0] = i·g`, `F[0][j] = j·g`', right: '`H[i][0] = 0`, `H[0][j] = 0`' },
    { aspect: '递推公式', left: '3 个选项', right: '4 个选项（多一个 0）' },
    { aspect: '回溯起点', left: '固定在 `(m, n)`', right: '矩阵中的最大值位置' },
    { aspect: '回溯终点', left: '固定在 `(0, 0)`', right: '遇到 0 时停止' },
    { aspect: '适用场景', left: '序列整体相似', right: '寻找局部保守片段' }
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'Needleman-Wunsch 算法', to: '/wiki-bioinfo/alignment/needleman-wunsch', description: 'Smith-Waterman 对应的全局比对算法' },
    { title: 'Gotoh 算法', to: '/wiki-bioinfo/alignment/gotoh', description: '将 affine gap penalty 引入局部比对的理论基础' },
    { title: 'BLAST', to: '/wiki-bioinfo/alignment/blast', description: '基于 Smith-Waterman 思想的实际数据库搜索工具' },
    { title: '编辑距离', to: '/wiki-bioinfo/alignment/edit-distance', description: '理解比对 DP 递推关系的最简起点' },
    { title: '打分矩阵与 gap 罚分', to: '/wiki-bioinfo/alignment/scoring-matrices', description: '影响局部比对结果的打分体系说明' },
  ]}
/>
