---
title: "重复序列、分叉与图清理"
description: 基因组组装中重复序列导致的图拓扑问题（tips、bubbles、repeat edges）及其清理算法。
---
...
<RelatedLinks
  links={[
    { title: 'de Bruijn graph 组装', to: '/wiki-bioinfo/assembly/de-bruijn', description: '图清理所基于的 de Bruijn 图模型' },
    { title: 'OLC：Overlap-Layout-Consensus', to: '/wiki-bioinfo/assembly/olc', description: 'OLC 范式中重叠图的结构与清理' },
    { title: '图遍历算法', to: '/wiki-bioinfo/assembly/graph-traversal-algorithms', description: 'DFS/BFS 在图清理中的遍历策略' },
    { title: '测序 reads、coverage 与错误模型', to: '/wiki-bioinfo/foundations/sequencing-reads-coverage', description: '理解 coverage 分布对图清理阈值选择的影响' },
    { title: '组装评估', to: '/wiki-bioinfo/assembly/assembly-evaluation', description: '图清理对组装质量的影响评估' },
  ]}
/>
