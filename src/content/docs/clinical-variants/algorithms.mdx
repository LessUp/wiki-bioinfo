...
<PrerequisitesBox
  items={[
    {name: '变异注释与优先级排序', href: '/wiki-bioinfo/clinical-variants/variant-annotation-and-prioritization'},
    {name: 'ACMG 指南', href: '/wiki-bioinfo/clinical-variants/acmg-guidelines'},
...
<figure>
  <img src="/img/illustrations/variant-prioritization.svg" alt="临床变异优先级排序流水线：从 VCF 列表经频率过滤、功能影响、表型匹配到候选收敛" />
  <figcaption>临床变异优先级排序流水线：从大量变异逐步收敛到候选致病变异</figcaption>
</figure>
