...
1. **[变异注释与优先级排序](./variant-annotation-and-prioritization.md)** — 掌握从海量候选中筛选的策略与多维证据权衡
2. **[ACMG 指南](./acmg-guidelines.md)** — 理解证据标准化、强度分级和分类整合规则
3. **[CNV 与 SV 解释](./cnv-and-sv-interpretation.md)** — 学习大片段变异的特殊评估维度
4. **[临床变异解释算法](./algorithms.md)** — 了解计算工具如何辅助但不替代临床判断
