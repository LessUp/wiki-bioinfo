...
1. **[变异注释与优先级排序](./variant-annotation-and-prioritization/)** — 掌握从海量候选中筛选的策略与多维证据权衡
2. **[ACMG 指南](./acmg-guidelines/)** — 理解证据标准化、强度分级和分类整合规则
3. **[CNV 与 SV 解释](./cnv-and-sv-interpretation/)** — 学习大片段变异的特殊评估维度
4. **[临床变异解释算法](./algorithms/)** — 了解计算工具如何辅助但不替代临床判断

## 与其他板块的连接

- 原始检测流程见 [变异检测](../variants/index/)；
- 大型重排证据可参考 [长读长测序](../long-read/index/)；
- 人群频率与祖源背景可参考 [群体遗传学](../population/index/)。
