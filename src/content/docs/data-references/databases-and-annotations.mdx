...
<RelatedLinks
  links={[
    ...
    },
    {
      ...
      to: '/wiki-bioinfo/data-references/reference-versions-and-liftover',
      label: '版本背景',
    ...
    {
      title: '常见文件格式概览',
      to: '/wiki-bioinfo/formats/common-file-formats',
      label: '文件接口',
    ...
    },
    {
      ...
      description: 'ClinVar、gnomAD 等变异数据库在 ACMG 致病性评估中的使用。',
    },
    {
      title: 'VCF/BCF 格式',
      to: '/wiki-bioinfo/formats/vcf-bcf-format',
      description: '变异数据库信息通常以 VCF 格式附加到变异注释中。',
    },
  ]}
/>
