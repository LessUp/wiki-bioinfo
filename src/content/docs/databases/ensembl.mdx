...
<PrerequisitesBox
  items={[
    ...
    {name: 'GTF/GFF/BED 格式', href: '/wiki-bioinfo/formats/gtf-gff-bed'},
...
<ComparisonTable
  leftTitle="Ensembl ID"
  rightTitle="Gene Symbol"
  rows={[
    { aspect: '**稳定性**', left: '稳定，不随注释变化', right: '可能随注释更新而变化' },
    { aspect: '**唯一性**', left: '唯一对应一个对象', right: '可能存在歧义' },
    { aspect: '**层级**', left: '区分 gene/transcript/protein', right: '通常只指基因层' },
    { aspect: '**推荐使用**', left: '分析流程和数据库映射', right: '人工阅读和文献交流' }
  ]}
/>
