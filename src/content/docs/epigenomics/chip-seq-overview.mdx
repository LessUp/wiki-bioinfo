...
<figure>
  <img src="/img/illustrations/chip-seq-workflow.svg" alt="ChIP-seq 实验流程概览" />
  <figcaption>ChIP-seq 实验流程：从交联到测序的完整步骤</figcaption>
</figure>
  ...
  items={[
    {
      ...
      definition: '由转录因子（如 CTCF）产生。峰形尖锐（< 1 kb），反映了蛋白对特定 Motif 的精确识别。',
    },
    {
      term: '宽峰（Broad Peaks）',
