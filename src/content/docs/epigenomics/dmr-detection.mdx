...
<PrerequisitesBox
  prerequisites={[
    { title: 'DNA 甲基化', href: '/wiki-bioinfo/epigenomics/dna-methylation', description: 'DNA 甲基化的生物学基础' },
    { title: '统计检验与多重校正', href: '/wiki-bioinfo/foundations/probability-and-graphs', description: '假设检验与 FDR 校正原理' },
    { title: 'HMM 与 Viterbi 算法', href: '/wiki-bioinfo/models/viterbi-forward-backward', description: '贝叶斯分段方法的算法基础' },
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'DNA 甲基化', to: '/wiki-bioinfo/epigenomics/dna-methylation', description: 'DNA 甲基化的生物学基础与检测技术' },
    { title: 'ChIP-seq 概览', to: '/wiki-bioinfo/epigenomics/chip-seq-overview', description: '表观遗传学的另一核心实验技术' },
    { title: '统计检验与多重校正', to: '/wiki-bioinfo/foundations/probability-and-graphs', description: 'DMR 检验的统计学基础' },
    { title: 'HMM 与 Viterbi 算法', to: '/wiki-bioinfo/models/viterbi-forward-backward', description: '贝叶斯推断与序列建模方法' }
  ]}
/>
