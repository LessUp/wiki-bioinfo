...
<PrerequisitesBox
  prerequisites={[
    { title: 'ATAC-seq', href: '/wiki-bioinfo/epigenomics/atac-seq', description: 'ATAC-seq 实验原理与数据特点' },
    { title: 'PWM / PSSM', href: '/wiki-bioinfo/models/pwm-pssm', description: '转录因子结合偏好性模型' },
    { title: 'MACS2 峰调用算法', href: '/wiki-bioinfo/epigenomics/macs2-peak-calling', description: '开放染色质区域的识别' },
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'ATAC-seq', to: '/wiki-bioinfo/epigenomics/atac-seq', description: 'ATAC-seq 实验原理与数据分析' },
    { title: 'ChIP-seq 概览', to: '/wiki-bioinfo/epigenomics/chip-seq-overview', description: '染色质免疫沉淀测序基础' },
    { title: 'PWM / PSSM', to: '/wiki-bioinfo/models/pwm-pssm', description: '转录因子结合偏好性模型' },
    { title: '统计检验与多重校正', to: '/wiki-bioinfo/foundations/probability-and-graphs', description: 'Footprint 检验的统计学基础' }
  ]}
/>
