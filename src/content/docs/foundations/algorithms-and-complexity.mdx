...
<RelatedLinks
  links={[
    { title: '穷举搜索', to: '/wiki-bioinfo/foundations/exhaustive-search', description: '理解暴力破解与剪枝' },
    { title: '换钱问题', to: '/wiki-bioinfo/foundations/change-problem', description: '动态规划的入门案例' },
    { title: '基因组重排', to: '/wiki-bioinfo/foundations/genome-rearrangements', description: '贪心算法的挑战' },
    { title: '序列比对入门', to: '/wiki-bioinfo/alignment', description: '将算法应用于真实的生物序列' }
  ]}
/>
