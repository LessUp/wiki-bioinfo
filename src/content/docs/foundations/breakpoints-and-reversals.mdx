...
<PrerequisitesBox
  items={[
    { name: '贪心算法', href: '/wiki-bioinfo/foundations/greedy-algorithms' },
...
<RelatedLinks
  links={[
    { title: '基因组重排', to: '/wiki-bioinfo/foundations/genome-rearrangements', description: '更广泛的基因组重排问题' },
    { title: '贪心算法', to: '/wiki-bioinfo/foundations/greedy-algorithms', description: '算法设计策略' },
    { title: '近似算法', to: '/wiki-bioinfo/foundations/approximation-algorithms', description: '近似保证的理论基础' }
  ]}
/>
