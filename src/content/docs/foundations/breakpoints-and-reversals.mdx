...
<RelatedLinks
  items={[
    { name: '基因组重排', href: '/wiki/foundations/genome-rearrangements', description: '更广泛的基因组重排问题' },
    { name: '贪心算法', href: '/wiki/foundations/greedy-algorithms', description: '算法设计策略' },
    { name: '近似算法', href: '/wiki/foundations/approximation-algorithms', description: '近似保证的理论基础' }
  ]}
/>
