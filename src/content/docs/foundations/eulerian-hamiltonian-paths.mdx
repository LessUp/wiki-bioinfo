...
<RelatedLinks
  links={[
    { title: 'de Bruijn 图', to: '/wiki/assembly/de-bruijn-graph', description: '组装中的核心图结构' },
    { title: 'SBH 测序', to: '/wiki/assembly/sequencing-by-hybridization', description: '欧拉路径的经典应用' },
    { title: '基因组组装', to: '/wiki/assembly/', description: '组装方法概览' }
  ]}
/>
