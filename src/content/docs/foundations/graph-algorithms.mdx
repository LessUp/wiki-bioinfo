...
<RelatedLinks
  links={[
    { title: 'de Bruijn graph 组装', to: '/wiki-bioinfo/assembly/de-bruijn', description: 'de Bruijn graph 是图算法在基因组组装中最经典的应用。' },
    { title: '系统发育树概览', to: '/wiki-bioinfo/phylogeny/index', description: '系统发育树的构建和遍历本质上是图算法问题。' },
    { title: '动态规划基础', to: '/wiki-bioinfo/foundations/dynamic-programming-basics', description: '序列比对可以看作在网格图上寻找最优路径的 DP 问题。' },
    { title: '概率、图与动态规划预备', to: '/wiki-bioinfo/foundations/probability-and-graphs', description: '图论的概率基础，为图算法提供数学工具。' },
    { title: '欧拉路径与哈密顿路径', to: '/wiki-bioinfo/foundations/eulerian-hamiltonian-paths', description: '欧拉路径是组装图遍历的核心，哈密顿路径对应 OLC 组装。' },
  ]}
/>
