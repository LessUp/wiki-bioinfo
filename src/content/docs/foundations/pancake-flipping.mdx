...
<PrerequisitesBox
  items={[
    ...
    { name: '断点', href: '/wiki-bioinfo/foundations/breakpoints-and-reversals' },
...
<RelatedLinks
  links={[
    { title: '基因组重排', to: '/wiki-bioinfo/foundations/genome-rearrangements', description: '更一般的重排问题' },
    { title: '断点', to: '/wiki-bioinfo/foundations/breakpoints-and-reversals', description: '断点分析方法' },
    { title: '近似算法', to: '/wiki-bioinfo/foundations/approximation-algorithms', description: '近似算法理论' }
  ]}
/>
