...
1. [开始这里](./index.md)
2. [算法入门](./algorithms-intro.mdx)
3. [基础与数学](../foundations/index.md)
4. [算法与复杂度](../foundations/algorithms-and-complexity.md)
5. [核心方法](../core-methods/index.mdx)
6. [序列表示与索引](../sequence/index.mdx)
7. [精确字符串匹配](../sequence/exact-string-matching.md)
8. [Suffix Array、BWT 与索引压缩](../sequence/suffix-array-bwt.md)
9. [FM-index](../sequence/fm-index.mdx)
10. [序列比对](../alignment/index.mdx)
11. [编辑距离](../alignment/edit-distance.md)
12. [多序列比对（MSA）](../alignment/multiple-sequence-alignment.md)
13. [系统发育与进化](../phylogeny/index.mdx)
14. [概率模型与模式识别](../models/index.mdx)
15. [隐马尔可夫模型](../models/hmm.md)
16. [Gene prediction](../models/gene-prediction.md)

## 路线三：实战流程路线

适合已经接触测序数据、想把工具和原理串起来的读者。

1. [基础与数学](../foundations/index.mdx)
2. [数据、注释与资源](../data-references/index.mdx)
3. [常见文件格式概览](../formats/common-file-formats.mdx)
4. [分析方向与案例](../applications/index.mdx)
5. [工作流与案例](../workflows/index.mdx)
