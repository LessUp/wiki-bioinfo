...
| 序号 | 主题 | 核心内容 |
|------|------|----------|
| 1 | [开始这里](./index.md) | 知识库结构导览 |
| 2 | [基础与数学](../foundations/index.md) | 必需的计算与数学基础 |
| 3 | [生物信息学中的基础对象](../foundations/biology-basics.md) | DNA、RNA、蛋白质、基因组 |
| 4 | [测序技术原理](../foundations/sequencing-reads-coverage.md) | reads、coverage、错误模型 |
...
| **基础** | [算法与复杂度](../foundations/algorithms-and-complexity.md) | 复杂度分析与算法设计原则 |
| **字符串** | [序列表示与索引](../sequence/index.mdx) | 字符串模型、k-mer |
| | [精确字符串匹配](../sequence/exact-string-matching.md) | 模式匹配算法 |
| | [Suffix Array 与 BWT](../sequence/suffix-array-bwt.md) | 后缀数组、Burrows-Wheeler 变换 |
| | [FM-index](../sequence/fm-index.mdx) | 压缩索引结构 |
| **比对** | [序列比对](../alignment/index.mdx) | 比对问题的计算本质 |
| | [编辑距离](../alignment/edit-distance.md) | 动态规划基础 |
| | [多序列比对](../alignment/multiple-sequence-alignment.md) | MSA 算法策略 |
| **进化** | [系统发育](../phylogeny/index.mdx) | 树重构算法 |
| **模型** | [概率模型](../models/index.mdx) | 统计建模框架 |
| | [隐马尔可夫模型](../models/hmm.md) | HMM 及其应用 |
| | [基因预测](../models/gene-prediction.md) | 基于模型的预测方法 |
...
| **RNA** | [RNA-seq 工作流](../workflows/rna-seq.md) | 差异表达分析完整流程 |
...
- [关于本项目](./about.md) — 知识库的设计理念
- [算法入门](./algorithms-intro.mdx) — 算法思维的系统介绍
- [写作规范](./style-guide.md) — 页面类型与内容模板
