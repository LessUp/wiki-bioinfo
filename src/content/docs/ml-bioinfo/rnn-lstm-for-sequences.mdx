...
- [序列深度学习](./deep-learning-for-sequences.mdx)
- [嵌入与语言模型](./embeddings-and-language-models.mdx)
- [CNN for Sequences](./cnn-for-sequences.mdx)
- [Transformer for Sequences](./transformer-for-sequences.mdx)
- [HMM](../models/hmm.mdx)
