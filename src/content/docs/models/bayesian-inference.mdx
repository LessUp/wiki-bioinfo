...
<ComparisonTable
  ...
  rightTitle="贝叶斯学派"
  rows={[
    { aspect: '参数观点', left: '固定未知常数', right: '随机变量' },
    { aspect: '推断基础', left: '重复抽样', right: '条件概率' },
    { aspect: '不确定性', left: '置信区间', right: '可信区间' },
    { aspect: '先验信息', left: '不使用', right: '明确使用' },
    { aspect: '计算复杂度', left: '通常较低', right: '可能较高' },
    { aspect: '小样本表现', left: '可能不稳定', right: '可以更稳定' }
  ]}
/>
