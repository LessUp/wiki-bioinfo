...
<RelatedLinks
  links={[
    { title: '剪接比对', to: '/wiki/models/spliced-alignment', description: '考虑全局比对约束的改进方法' },
    { title: '基因预测', to: '/wiki/models/gene-prediction', description: '更全面的基因预测方法' },
    { title: '动态规划', to: '/wiki/foundations/dynamic-programming-basics', description: 'DP 基础理论' }
  ]}
/>
