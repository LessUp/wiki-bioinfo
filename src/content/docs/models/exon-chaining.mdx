...
<PrerequisitesBox
  items={[
    ...
    { name: 'DAG 最长路径', href: '/wiki-bioinfo/foundations/dag-longest-path' },
    { name: '基因预测', href: '/wiki-bioinfo/models/gene-prediction' }
  ]}
/>
...
<RelatedLinks
  links={[
    { title: '剪接比对', to: '/wiki-bioinfo/models/spliced-alignment', description: '考虑全局比对约束的改进方法' },
    { title: '基因预测', to: '/wiki-bioinfo/models/gene-prediction', description: '更全面的基因预测方法' },
    { title: '动态规划', to: '/wiki-bioinfo/foundations/dynamic-programming-basics', description: 'DP 基础理论' }
  ]}
/>
