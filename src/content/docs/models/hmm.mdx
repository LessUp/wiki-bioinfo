...
<RelatedLinks
  links={[
    { title: 'Viterbi、Forward 与 Backward', to: '/wiki-bioinfo/models/viterbi-forward-backward', description: 'HMM 的三个核心推断算法，分别解决 decoding、evaluation 和 posterior 问题。' },
    { title: '概率、图与动态规划预备', to: '/wiki-bioinfo/foundations/probability-and-graphs', description: 'HMM 的理论基础依赖概率论，推断算法依赖动态规划。' },
    { title: 'Gene prediction', to: '/wiki-bioinfo/models/gene-prediction', description: 'HMM 在基因预测中用于将序列分段为 exon/intron/intergenic。' },
    { title: 'Profile HMM', to: '/wiki-bioinfo/models/profile-hmm', description: 'Profile HMM 是 HMM 在蛋白家族建模上的专门化扩展。' },
    { title: '动态规划基础', to: '/wiki-bioinfo/foundations/dynamic-programming-basics', description: '理解 DP 思想有助于掌握 Viterbi 和 Forward-Backward 算法。' },
  ]}
/>
