...
1. [Motif 寻找](./motif-finding/)
2. [Motif discovery 的算法路线](./motif-discovery-algorithms/)
3. [PWM 与 PSSM](./pwm-pssm/)
4. [隐马尔可夫模型](./hmm/)
5. [Viterbi、Forward 与 Backward](./viterbi-forward-backward/)
6. [Profile HMM](./profile-hmm/)
7. [EM算法](./em-algorithm/)
8. [贝叶斯推断基础](./bayesian-inference/)
9. [Gene prediction](./gene-prediction/)
