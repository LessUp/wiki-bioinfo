...
<SectionNavigator
  items={[
    ...
    },
    {
      ...
      to: '/wiki-bioinfo/models/motif-discovery-algorithms',
      badge: '算法桥梁',
    ...
    {
      title: 'PWM 与 PSSM',
      to: '/wiki-bioinfo/models/pwm-pssm',
      badge: '矩阵表示',
    ...
    },
    {
      ...
      to: '/wiki-bioinfo/models/viterbi-forward-backward',
      badge: '推断算法',
    ...
    {
      title: 'Profile HMM',
      to: '/wiki-bioinfo/models/profile-hmm',
      badge: '家族模型',
    ...
    {
      title: 'EM算法',
      to: '/wiki-bioinfo/models/em-algorithm',
      badge: '参数估计',
    ...
    {
      title: '贝叶斯推断基础',
      to: '/wiki-bioinfo/models/bayesian-inference',
      badge: '统计推断',
      meta: 'bayesian',
    ...
    },
    {
      ...
      to: '/wiki-bioinfo/models/gene-prediction',
      badge: '应用落地',
      meta: 'annotation',
