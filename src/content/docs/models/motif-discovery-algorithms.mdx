...
<PrerequisitesBox
  links={[
    ...
    { title: '随机化算法', href: '/wiki-bioinfo/foundations/randomized-algorithms' },
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'Motif 寻找', to: '/wiki-bioinfo/models/motif-finding', description: '从 motif 的定义和理解出发，再看 discovery 算法会更清晰。' },
    { title: 'PWM 与 PSSM', to: '/wiki-bioinfo/models/pwm-pssm', description: 'Motif discovery 的输出通常是 PWM/PSSM 形式的 motif 模型。' },
    { title: '随机化算法', to: '/wiki-bioinfo/foundations/randomized-algorithms', description: 'Gibbs Sampling 和随机化搜索是 motif discovery 的核心随机化方法。' },
    { title: 'Median String 问题', to: '/wiki-bioinfo/models/median-string', description: 'Median String 是 motif finding 的等价表述，提供了不同的搜索视角。' },
    { title: '穷举搜索与分支定界', to: '/wiki-bioinfo/foundations/exhaustive-search', description: '穷举是 motif discovery 的概念基线，分支定界是其精确求解策略。' },
  ]}
/>
