...
<PrerequisitesBox
  items={[
    ...
    { name: '贪心算法', href: '/wiki-bioinfo/foundations/algorithms-and-complexity' },
...
<RelatedLinks
  links={[
    { title: '隐马尔可夫模型', to: '/wiki-bioinfo/models/hmm', description: '更复杂的序列状态建模' },
    { title: '穷举搜索', to: '/wiki-bioinfo/foundations/exhaustive-search', description: '中间字符串问题的暴力解法' },
    { title: '动态规划基础', to: '/wiki-bioinfo/foundations/dynamic-programming-basics', description: '另一种优化搜索策略' }
  ]}
/>
