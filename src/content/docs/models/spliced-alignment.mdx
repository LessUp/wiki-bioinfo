...
<PrerequisitesBox
  items={[
    { name: 'Exon Chaining', href: '/wiki-bioinfo/models/exon-chaining' },
    { name: '序列比对', href: '/wiki-bioinfo/alignment/needleman-wunsch' },
...
<ComparisonTable
  leftTitle="Exon Chaining"
  rightTitle="剪接比对"
  rows={[
    { aspect: '权重', left: '预定义固定值', right: '与目标蛋白的比对得分' },
    { aspect: '路径权重', left: '边权重之和', right: '与路径相关的复杂函数' },
    { aspect: '全局约束', left: '无', right: '有（蛋白序列连续性）' }
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'Exon Chaining', to: '/wiki-bioinfo/models/exon-chaining', description: '基础的外显子选择算法' },
    { title: '基因预测', to: '/wiki-bioinfo/models/gene-prediction', description: '更全面的预测方法' },
    { title: 'HMM 基因预测', to: '/wiki-bioinfo/models/hmm', description: '统计方法的基因预测' }
  ]}
/>
