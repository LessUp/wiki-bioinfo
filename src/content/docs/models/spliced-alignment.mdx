...
<RelatedLinks
  items={[
    { name: 'Exon Chaining', href: '/wiki/models/exon-chaining', description: '基础的外显子选择算法' },
    { name: '基因预测', href: '/wiki/models/gene-prediction', description: '更全面的预测方法' },
    { name: 'HMM 基因预测', href: '/wiki/models/hmm', description: '统计方法的基因预测' }
  ]}
/>
