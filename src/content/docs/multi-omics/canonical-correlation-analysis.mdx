...
<RelatedLinks
  links={[
    { title: '整合算法概览', to: '/wiki-bioinfo/multi-omics/integration-algorithms', description: 'CCA 在多组学整合算法中的定位' },
    { title: '联合 NMF', to: '/wiki-bioinfo/multi-omics/joint-nmf', description: '基于重构误差的替代整合方法' },
