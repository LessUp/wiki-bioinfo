---
description: Maximum Likelihood最大似然法：在给定演化模型下寻找最可能产生观测数据的系统发育树。
...
<PrerequisitesBox
  prerequisites={[
    { title: 'Neighbor-Joining 算法', href: '/wiki-bioinfo/phylogeny/neighbor-joining', description: '距离矩阵建树的基础方法' },
    { title: 'Parsimony 算法', href: '/wiki-bioinfo/phylogeny/parsimony', description: '位点级系统发育推断的对比方法' },
    { title: '多序列比对（MSA）', href: '/wiki-bioinfo/alignment/multiple-sequence-alignment', description: 'ML 分析的输入数据' },
  ]}
/>
...
<RelatedLinks
  links={[
    { title: 'Parsimony 算法', to: '/wiki-bioinfo/phylogeny/parsimony', description: '无需概率模型的最简变化方法' },
    { title: 'Neighbor-Joining 算法', to: '/wiki-bioinfo/phylogeny/neighbor-joining', description: 'ML 常用的初始化方法' },
    { title: 'UPGMA 算法', to: '/wiki-bioinfo/phylogeny/upgma', description: '基于分子钟假设的层次聚类方法' },
    { title: '多序列比对（MSA）', to: '/wiki-bioinfo/alignment/multiple-sequence-alignment', description: 'ML 分析的输入数据准备' }
  ]}
/>
