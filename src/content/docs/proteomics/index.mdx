...
| 章节 | 核心问题 | 算法技术 |
|------|---------|---------|
| [质谱基础](./mass-spectrometry-basics/) | 理解 MS1/MS2、谱图构建、肽段测序问题 | 谱图图（Spectrum Graph）、动态规划 |
| [数据库搜索与 FDR](./database-search-and-fdr/) | 蛋白质鉴定、假阳性控制 | 共享峰计数、Target-Decoy 策略 |
| [定量蛋白质组学](./quantitative-proteomics/) | 蛋白质丰度比较 | Label-free、TMT/iTRAQ |
| [谱卷积](./spectral-convolution/) | 修饰肽段检测 | 谱卷积算法 |
| [谱对齐](./spectral-alignment/) | 精确定位修饰位点 | 动态规划、$k$-相似性 |
| [谱图图](./spectrum-graphs/) | 从头肽段测序 | DAG 最长路径 |
...
- **上游知识**：[序列分析基础](../sequence/index/)、[动态规划](../foundations/dynamic-programming-basics/)
- **下游应用**：[临床变异解释](../clinical-variants/index/)
- **相关技术**：[机器学习与蛋白语言模型](../ml-bioinfo/index/)
