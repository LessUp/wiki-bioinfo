...
| 章节 | 核心问题 | 算法技术 |
|------|---------|---------|
| [质谱基础](./mass-spectrometry-basics.md) | 理解 MS1/MS2、谱图构建、肽段测序问题 | 谱图图（Spectrum Graph）、动态规划 |
| [数据库搜索与 FDR](./database-search-and-fdr.md) | 蛋白质鉴定、假阳性控制 | 共享峰计数、Target-Decoy 策略 |
| [定量蛋白质组学](./quantitative-proteomics.md) | 蛋白质丰度比较 | Label-free、TMT/iTRAQ |
...
- **上游知识**：[序列分析基础](../sequence/index.md)、[动态规划](../foundations/dynamic-programming-basics.md)
- **下游应用**：[临床变异解释](../clinical-variants/index.md)、[系统生物学](../pathways/index.md)
- **相关技术**：[机器学习与蛋白语言模型](../ml-bioinfo/index.md)
