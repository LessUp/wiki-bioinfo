...
<PrerequisitesBox
  items={[
    ...
    { name: '图算法', href: '/wiki-bioinfo/foundations/graph-algorithms' },
    { name: '序列比对', href: '/wiki-bioinfo/alignment/global-local' }
  ]}
/>
...
<SectionNavigator
  items={[
    {
      title: '质谱基础',
      to: '/wiki-bioinfo/proteomics/mass-spectrometry-basics',
      description: 'MS1/MS2 测量原理、肽段碎裂、谱图构建基础',
    },
    {
      title: '谱图图',
      to: '/wiki-bioinfo/proteomics/spectrum-graphs',
      description: '将质谱数据转换为有向无环图，从头肽段测序的图算法',
    },
    {
      title: '谱卷积',
      to: '/wiki-bioinfo/proteomics/spectral-convolution',
      description: '通过质量差分布检测翻译后修饰和突变',
    },
    {
      title: '谱对齐',
      to: '/wiki-bioinfo/proteomics/spectral-alignment',
      description: '动态规划算法精确定位修饰位点，k-相似性概念',
    },
    {
      title: '数据库搜索与 FDR',
      to: '/wiki-bioinfo/proteomics/database-search-and-fdr',
      description: '蛋白质鉴定、PSM、Target-Decoy 假阳性控制策略',
    },
    {
      title: '定量蛋白质组学',
      to: '/wiki-bioinfo/proteomics/quantitative-proteomics',
