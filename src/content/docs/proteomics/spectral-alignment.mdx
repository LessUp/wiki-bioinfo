...
<PrerequisitesBox
  items={[
    { name: '谱卷积', href: '/wiki-bioinfo/proteomics/spectral-convolution' },
...
<RelatedLinks
  links={[
    { title: '谱卷积', to: '/wiki-bioinfo/proteomics/spectral-convolution', description: '修饰检测的全局方法' },
    { title: '质谱基础', to: '/wiki-bioinfo/proteomics/mass-spectrometry-basics', description: 'MS1/MS2 原理' },
    { title: '动态规划', to: '/wiki-bioinfo/foundations/dynamic-programming-basics', description: '动态规划算法基础' },
    { title: '序列比对', to: '/wiki-bioinfo/alignment/global-local', description: '编辑距离与序列比对' }
  ]}
/>
