...
<PrerequisitesBox
  items={[
    ...
    { name: '有向无环图（DAG）', href: '/wiki/foundations/graph-algorithms' },
    { name: '最长路径问题', href: '/wiki/foundations/graph-algorithms' },
...
<RelatedLinks
  links={[
    { title: '质谱基础', to: '/wiki/proteomics/mass-spectrometry-basics', description: 'MS1/MS2 原理与肽段测序问题' },
    { title: '谱卷积', to: '/wiki/proteomics/spectral-convolution', description: '修饰检测的谱卷积方法' },
    { title: '谱对齐', to: '/wiki/proteomics/spectral-alignment', description: '动态规划谱对齐算法' },
    { title: '数据库搜索与 FDR', to: '/wiki/proteomics/database-search-and-fdr', description: '蛋白质鉴定的数据库搜索方法' },
    { title: '图算法', to: '/wiki/foundations/graph-algorithms', description: 'DAG 最长路径与动态规划' }
  ]}
/>
