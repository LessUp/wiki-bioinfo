...
<SummaryBox
  summary="当参考序列达到 3 Gb 规模时，我们需要在极小的内存开销下实现极速查询。Suffix Array 将后缀组织成有序数组，而 BWT 则进一步通过数据变换实现了索引的可压缩性与后向搜索的高效性。"
  bullets={[
...
<RelatedLinks
  links={[
    ...
    { title: 'Minimap2 比对', to: '/wiki-bioinfo/long-read/minimap2-alignment', description: 'BWT 索引的长读长应用' },
