...
- **[分子生物学基础](../molecular-bioinfo/)**：氨基酸、蛋白质合成、中心法则
- **[序列比对](../alignment/sequence-alignment/)**：理解多序列比对（MSA）的概念
...
- **[药物发现](../drug-discovery/)**（如适用）：基于结构的药物设计
- **[分子动力学模拟](../md-simulation/)**（如适用）：理解蛋白动态
