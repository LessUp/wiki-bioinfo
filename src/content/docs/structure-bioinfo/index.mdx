...
<SectionNavigator
  items={[
    ...
    {
      title: '分子动力学基础',
      to: '/wiki-bioinfo/structure-bioinfo/molecular-dynamics-basics',
...
<RelatedLinks
  links={[
    { title: '概率模型与模式识别', to: '/wiki-bioinfo/models/', description: 'HMM 和 profile HMM 是蛋白家族分析的经典方法' },
    { title: '序列比对', to: '/wiki-bioinfo/alignment/', description: '多序列比对（MSA）是结构预测和比较的关键输入' },
    { title: '蛋白质组学', to: '/wiki-bioinfo/proteomics/', description: '结构信息支撑大规模蛋白质功能注释与互作预测' },
    { title: '机器学习与基础模型', to: '/wiki-bioinfo/ml-bioinfo/', description: 'AlphaFold 等深度学习方法推动了结构预测的范式转变' },
  ]}
/>
