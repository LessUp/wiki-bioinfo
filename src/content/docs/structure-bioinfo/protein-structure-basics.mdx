...
<RelatedLinks
  links={[
    { title: 'AlphaFold 与结构预测', href: '/wiki-bioinfo/structure-bioinfo/alphafold-and-structure-prediction', description: '现代计算结构预测方法' },
    { title: '结构比对与 fold', href: '/wiki-bioinfo/structure-bioinfo/structure-alignment-and-fold', description: '结构相似性比较方法' },
    { title: '蛋白质组学', href: '/wiki-bioinfo/proteomics', description: '大规模蛋白质研究' },
  ]}
/>
