...
<RelatedLinks
  links={[
    ...
    { title: 'AlphaFold 与结构预测', href: '/wiki-bioinfo/structure-bioinfo/alphafold-and-structure-prediction', description: '现代结构预测与置信度评估' },
    { title: '系统发育与进化', href: '/wiki-bioinfo/phylogeny', description: '进化关系分析方法' },
  ]}
/>
