  ...
  items={[
    {
      ...
      definition: '一段序列紧密首尾相连。包括微卫星（STR, 1-6 bp 单元） 和卫星 DNA。极易发生"复制滑移"，是 Indel 变异的高发区。',
    },
    {
    ...
    },
    {
      ...
      definition: '长度 >1 kb 且高度相似（>90%） 的大片段。是产生拷贝数变异（CNV） 的温床。',
    },
  ]}
/>
...
<RelatedLinks
  links={[
    ...
    { title: '编辑距离与比对基础', to: '/wiki-bioinfo/alignment/edit-distance', description: '理解重复导致的比对不确定性' }
  ]}
/>
