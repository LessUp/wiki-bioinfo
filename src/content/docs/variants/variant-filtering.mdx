...
<PrerequisitesBox
  items={[
    { title: 'DNA-seq 变异检测总览', to: '/wiki-bioinfo/variants/variant-calling-overview' },
...
<RelatedLinks
  links={[
    { title: 'DNA-seq 变异检测总览', to: '/wiki-bioinfo/variants/variant-calling-overview', description: '过滤在变异检测流程中的位置' },
    { title: '序列比对', to: '/wiki-bioinfo/alignment/index', description: '比对质量影响过滤决策' },
    { title: '常见文件格式概览', to: '/wiki-bioinfo/formats/common-file-formats', description: 'VCF/BAM 等核心文件格式' },
    { title: '测序 Reads 与覆盖度', to: '/wiki-bioinfo/foundations/sequencing-reads-coverage', description: '深度与错误模型的基础' }
  ]}
/>
